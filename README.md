...
![FQC Home Screen](screenshots/home-screen.png)
...
![FQC Input Screen](screenshots/input-screen.png)
...
![FQC Result Screen](screenshots/result-screen.png)

> **Screenshot Placeholder:** Add the Result Screen screenshot to `screenshots/result-screen.png`.

## 📂 Screenshot Directory

The screenshots should be placed in the following directory:
